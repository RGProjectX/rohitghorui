    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto space-y-8">
        ...
        >
          ...
          >
            <span className="absolute inset-0 bg-foreground scale-0 group-hover:scale-100 transition-transform duration-500 origin-right rounded-full" />
            <span className="relative z-10">Let's Connect</span>
            <span className="relative z-10 h-8 w-8 rounded-full bg-foreground group-hover:bg-transparent flex items-center justify-center transition-colors duration-500">
